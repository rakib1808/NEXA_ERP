<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deemedExportLC.aspx.cs" Inherits="NEXA_ERP.Trims.deemedExportLC" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Deemed Export LC Entry Page</title>
        ...
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                ...
                <div class="flex gap-2 items-center bg-[#f0f0f0] hover:bg-[#cbd5e1] transition-all duration-200 px-2 py-1 rounded cursor-pointer">
                    ...
                    <asp:LinkButton ID="btnBackToList" runat="server" PostBackUrl="~/TrimsAccessories/EstimationCostings/OrdersReports/DeemedExportLCList.aspx">Back To Deemed Export LC List</asp:LinkButton>
                </div>
            </div>
            ...
            <div class="bg-[#ffffff] shadow-xl rounded-b-lg p-4">
                ...
                <div class="space-x-4 flex justify-end items-end mt-3">
                    ...
                    <asp:LinkButton ID="btnCancel" runat="server" CssClass="flex items-center gap-1.5 rounded bg-gray-500 text-white px-4 py-1.5 shadow-sm hover:bg-gray-600 cursor-pointer transition duration-200 ease-in-out font-medium text-sm no-underline justify-center">
                        <i class="fa-solid fa-ban"></i>
                        <span>Cancel</span>
                    </asp:LinkButton>

                    <asp:LinkButton ID="btnDelete" runat="server" CssClass="flex items-center gap-1.5 rounded bg-[#DC2626] text-white px-4 py-1.5 shadow-sm hover:bg-[#B91C1C] cursor-pointer transition duration-200 ease-in-out font-medium text-sm no-underline justify-center">
