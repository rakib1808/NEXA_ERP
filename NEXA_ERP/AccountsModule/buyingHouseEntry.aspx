<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buyingHouseEntry.aspx.cs" Inherits="NEXA_ERP.AccountsModule.buyingHouseEntry" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Buying House Entry</title>
        <!-- Tailwind CSS -->
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-2 py-1">
                <h1 class="text-2xl mb-1">Buying House Entry</h1>
            ...
            <div class="grid grid-cols-4 px-2 py-2 gap-x-2">
                ...
                <div class="col-span-1 border border-gray-400 rounded-xl bg-gray-50 px-2 py-2 min-h-screen">
                    <!--Section Title-->
                    <div>
                        <asp:Label ID="Label11" runat="server" Text="text" CssClass=" block font-bold mb-1">Buying House Info</asp:Label>
                    </div>
                    <!--Left card top part-->
                    <div class="border border-gray-400 rounded-xl bg-gray-50 px-2 py-2">
                        <!--BH Code -->
                        <div>
                            <asp:Label ID="Label2" runat="server" Text="text" CssClass=" block mb-1">BH Code</asp:Label>
                        ...
                        <!-- Buying House Name -->
                        <div>
                            <asp:Label ID="Label1" runat="server" Text="text" CssClass=" block mb-1">Buying House Name</asp:Label>
                        ...
                        <!-- Country -->
                        <div>
                            <asp:Label ID="Label3" runat="server" Text="text" CssClass=" block mb-1">Country</asp:Label>
                        ...
                        <!-- Contact Person -->
                        <div>
                            <asp:Label ID="Label6" runat="server" Text="text" CssClass=" block mb-1">Contact Person</asp:Label>
                        ...
                        <!-- Phone -->
                        <div>
                            <asp:Label ID="Label9" runat="server" Text="text" CssClass=" block mb-1">Phone</asp:Label>
                        ...
                        <!-- Link With Brand -->
                        <div>
                            <asp:Label ID="Label10" runat="server" Text="text" CssClass=" block mb-1">Link With Brand</asp:Label>
                ...
                <div class="col-span-3 border border-gray-400 rounded-xl bg-gray-50 px-2 min-h-screen">
                    <div>
                        <asp:Label ID="Label8" runat="server" Text="text" CssClass=" block mb-0.5">Buying House</asp:Label>
