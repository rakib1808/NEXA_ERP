<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stockClosing.aspx.cs" Inherits="NEXA_ERP.AccountsModule.stockClosing" %>
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-2 py-1">
                <h1 class="text-2xl mb-1">Stock Closing</h1>
            ...
            <div class="px-2 py-2 gap-x-2">
                ...
                <div class="flex items-center gap-x-2">
                    ...
                    <!-- Year -->
                    <div class="flex-1">
                        <asp:Label ID="Label13" runat="server" Text="text" CssClass=" block mb-1">Year</asp:Label>
                    ...
                    <!-- Month -->
                    <div class="flex-1">
                        <asp:Label ID="Label7" runat="server" Text="text" CssClass=" block mb-1">Month</asp:Label>
