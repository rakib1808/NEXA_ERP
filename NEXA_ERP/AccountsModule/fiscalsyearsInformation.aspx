<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fiscalsyearsInformation.aspx.cs" Inherits="NEXA_ERP.AccountsModule.fiscalsyearsInformation" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Fiscals Years Information</title>
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-2 py-1">
                <h1 class="text-2xl mb-1">Fiscals Years Information</h1>
            ...
            <div class="grid grid-cols-4 px-2 py-2 gap-x-2">
                ...
                <div class="col-span-2 border border-gray-400 rounded-xl bg-gray-50 px-2 py-2  max-h-screen">
                    ...
                    <!-- Year Name -->
                    <div>
                        <asp:Label ID="Label4" runat="server" Text="text" CssClass=" block mb-1">Year Name</asp:Label>
                    ...
                    <div class="flex items-center justify-between gap-x-2">
                        <!--Fiscal Year Form-->
                        <div>
                            <asp:Label ID="Label9" runat="server" Text="text" CssClass=" block mb-1">Fiscal Year Form</asp:Label>
                        ...
                        <!-- Fiscal Year Till -->
                        <div>
                            <asp:Label ID="Label13" runat="server" Text="text" CssClass=" block mb-1">Fiscal Year Till</asp:Label>
                        ...
                        <!-- Calander Year Form -->
                        <div>
                            <asp:Label ID="Label7" runat="server" Text="text" CssClass=" block mb-1">Calander Year Form</asp:Label>
                        ...
                        <!-- Calander Year Till -->
                        <div>
                            <asp:Label ID="Label8" runat="server" Text="text" CssClass=" block mb-1">Calander Year Till</asp:Label>
