<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentMode.aspx.cs" Inherits="NEXA_ERP.AccountsModule.PaymentMode" %>
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-2 py-1">
                <h1 class="text-2xl mb-1">Payment Mode</h1>
            ...
            <div class="grid grid-cols-4 px-2 py-2 gap-x-2">
                ...
                <!-- Voucher Type -->
                <div>
                    <asp:Label ID="Label4" runat="server" Text="text" CssClass="block mb-1">Voucher Type</asp:Label>
                    <div class="flex w-full gap-1">
                        <asp:TextBox ID="TextBox3" runat="server" CssClass="flex-1 border border-gray-400 h-8 px-2 outline-none rounded bg-white focus:border-blue-500 transition"> </asp:TextBox>
                        <asp:Button ID="Button1" runat="server" Text="Add" CssClass="bg-gray-500 hover:bg-gray-600 text-white h-8 w-20 rounded shadow-sm transition duration-200 cursor-pointer"></asp:Button>
                    </div>
                </div>
                <!-- Remarks -->
                <div>
