<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createYarnCount1.aspx.cs" Inherits="NEXA_ERP.createYarnCount1" %>
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <asp:Label ID="Label1" runat="server" Text="Yarn Count ID" CssClass="block mb-0.5"></asp:Label>
                    ...
                    <div>
                        <asp:Label ID="Label2" runat="server" Text="Count Number" CssClass="block  mb-0.5"></asp:Label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <asp:Label ID="Label3" runat="server" Text="Count System" CssClass="block mb-0.5">Count System</asp:Label>
                    ...
                    <div>
                        <asp:Label ID="Label4" runat="server" Text="Count Value" CssClass="block mb-0.5">Count Value</asp:Label>
