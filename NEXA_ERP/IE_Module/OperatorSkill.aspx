                    ...
                    <div class="col-span-3 space-y-2">            
                        ...
                        <!-- Bottom Side GridView -->
                            <fieldset class=" flex gap-2 border border-gray-400 rounded-lg p-1">
                                <legend class="px-2">Add Skills</legend>
                                <div class="w-full max-w-md">
                                    <label class="block">Factory</label>
                                    <asp:TextBox ID="TextBox13" runat="server" CssClass="w-full border border-gray-400 h-8 px-2 rounded focus:border-blue-500 outline-none transition"></asp:TextBox>
                                </div>
                                <div class="w-full max-w-md">
                                    <label class="block">Buyer Name</label>
                                    <asp:TextBox ID="TextBox14" runat="server" CssClass="w-full border border-gray-400 h-8 px-2 rounded focus:border-blue-500 outline-none transition"></asp:TextBox>
                                </div>
                                <div class="w-full max-w-md">
                                    <label class="block">PO No</label>
                                    <asp:TextBox ID="TextBox15" runat="server" CssClass="w-full border border-gray-400 h-8 px-2 rounded focus:border-blue-500 outline-none transition"></asp:TextBox>
                                </div>
                                <div class="w-full max-w-md">
                                    <label class="block">Factory</label>
