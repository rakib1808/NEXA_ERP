<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SewingoutputStaus.aspx.cs" Inherits="NEXA_ERP.IE_Module.SewingoutputStaus" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sewing Output Staus</title>
        <!-- Tailwind CSS -->
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-2 py-1">
                <h1 class="text-2xl mb-1">Sewing Output Staus</h1>
            ...
            <div class="px-2 py-2 gap-x-2">
                ...
                <div class="flex items-end gap-2 bg-gray-50 px-2 py-2">
                    <div class=" flex-1">
                        <label class="block mb-1">Order Placement Month</label>
                        <div class="flex">
                    ...
                    <div class="flex-1">
                        <label class="block mb-1">PO No</label>
