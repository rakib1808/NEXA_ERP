<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyManpowerStatus.aspx.cs" Inherits="NEXA_ERP.IE_Module.DailyManpowerStatus" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Daily Manpower Status</title>
        <!-- Tailwind CSS -->
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="px-2 py-2 gap-x-2">
                ...
                <!--Input Row-->
                <div class="flex items-end gap-2 bg-gray-50">
                    <div class="w-64">
