<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StyleChangeOverPoint.aspx.cs" Inherits="NEXA_ERP.IE_Module.StyleChangeOverPoint" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Style Change Over Point</title>
        <!-- Tailwind CSS -->
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden  max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-2 py-1">
                <h1 class="text-2xl mb-1">Style Change Over Point</h1>
            ...
            <div class="grid grid-cols-6 min-h-screen w-full bg-white p-4">
                <!-- Grid view main div -->
                <div class="col-span-4 border border-gray-400 rounded-xl bg-gray-50 px-2 overflow-auto min-h-screen">
                ...
                <div class="col-span-2 px-4">
                    ...
                    <div class="w-full max-w-md border border-gray-400 rounded-xl bg-white p-2 shadow-sm flex flex-col gap-4 h-fit">
                        ...
                        <div>
                            <label class="block mb-1">Mark</label>
