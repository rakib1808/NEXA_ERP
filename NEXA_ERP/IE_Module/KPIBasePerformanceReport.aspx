<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPIBasePerformanceReport.aspx.cs" Inherits="NEXA_ERP.IE_Module.KPIBasePerformanceReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>KPI Base Performance Report</title>
        <!-- Tailwind CSS -->
    ...
    <form id="form" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-2 py-1">
                <h1 class="text-2xl mb-1">KPI Base Performance Report</h1>
