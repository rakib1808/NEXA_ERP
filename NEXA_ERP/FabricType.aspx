<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricType.aspx.cs" Inherits="NEXA_ERP.FabricType" %>
    ...
    <form id="form1" runat="server" class="p-2">
        ...
        <div class="bg-white border border-gray-300 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="bg-[#0d6efd] text-white px-6 py-1">
                <h1 class="text-2xl mb-2">Fabric Type</h1>
            ...
            <!-- Body -->
             <div class="px-4 py-2 space-y-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <!-- Yarn Item ID -->
                    <div>
                        <asp:Label ID="Label2" runat="server" Text="text" CssClass=" block mb-0.5">Fabric Type ID</asp:Label>
                        <asp:TextBox ID="txtFabricTypeID" runat="server" ReadOnly="True"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <!-- Fabric Name -->
                    <div>
                        <asp:Label ID="Label5" runat="server" Text="text" CssClass="block mb-0.5">Fabric Name</asp:Label>
                        <asp:TextBox ID="txtFabricName" runat="server" CssClass="border border-gray-400 h-10 px-4 outline-none w-full rounded bg-white focus:border-blue-500 transition"></asp:TextBox>
                    </div>
                  </div>
                ...
                <!-- Row 3 -->
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <!-- Item Category -->
                    <div>
                        <asp:Label ID="Label6" runat="server" Text="text" CssClass="block mb-0.5">Item Category</asp:Label>
                        <asp:TextBox ID="txtItemCategory" runat="server" CssClass="border border-gray-400 h-10 px-4 outline-none w-full rounded bg-white focus:border-blue-500 transition"></asp:TextBox>
                    </div>
