<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeEntry1.aspx.cs" Inherits="NEXA_ERP.EmployeeEntry1" %>
        ...
        <div class="bg-white border border-gray-400 rounded-xl shadow-md overflow-hidden max-w-full mx-auto">
            ...
            <div class="p-2 space-y-6 text-right">
                ...
                <!-- Top Section -->
                  ...
                  <!-- Bottom Section -->
                  <div class="flex flex-wrap justify-between gap-2 px-3">
                    <!-- Left Box -->
                    <div class=" flex-1 min-w-[550px] border border-gray-400 rounded-lg p-2 space-y-2">

                        <div class="flex items-center">
                            <asp:Label ID="Label9" runat="server" Text="Label" CssClass="w-[100px] mx-2">Branch</asp:Label>
                        ...
                        <div class="flex items-center">
                            <asp:Label ID="Label10" runat="server" Text="Label" CssClass="w-[100px] mx-2">Department</asp:Label>
                        ...
                        <div class="flex items-center">
                            <asp:Label ID="Label11" runat="server" Text="Label" CssClass="w-[100px] mx-2">Section</asp:Label>
                        ...
                        <div class="flex items-center">
                            <asp:Label ID="Label12" runat="server" Text="Label" CssClass="w-[100px] mx-2">Line</asp:Label>
                        ...
                        <div class="flex items-center">
                            <asp:Label ID="Label13" runat="server" Text="Label" CssClass="w-[100px] mx-2">Designation</asp:Label>
                        ...
                        <div class="flex items-center">
                            <asp:Label ID="Label14" runat="server" Text="Label" CssClass="w-[100px] mx-2">Category</asp:Label>
                        ...
                        <div class="flex items-center">
                            <asp:Label ID="Label15" runat="server" Text="Label" CssClass="w-[100px] mx-2">Shift</asp:Label>
                        ...
                        <div class="flex items-center">
                            <asp:Label ID="Label16" runat="server" Text="Label" CssClass="w-[100px] mx-2">Floor</asp:Label>
